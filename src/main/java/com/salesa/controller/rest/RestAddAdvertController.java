...
public class RestAddAdvertController {
    ...
    public ResponseEntity<String> addAdvert(HttpServletRequest httpServletRequest, HttpSession session) throws IOException {
        ...
        Advert advert = constructAdvert(user, title, text, price, currency, status, categoryId);
