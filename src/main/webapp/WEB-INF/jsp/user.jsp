                            ...
                            <c:when test="${loggedUser.id == user.id}">
                                ...
                                <div class="wrap-info">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <p>
                                            <div class="glyphicon glyphicon-phone"></div>
                                            <input type="text" id="phone" size="20" value="">
                                            </p>
                                        </c:otherwise>
                                    </c:choose>
                                    <p>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <button disabled class="create"><strong>Создать объявление</strong></button>
                                    </c:otherwise>
                                </c:choose>
                                </p>
                                <c:choose>
                            ...
                            <c:otherwise>
                                    ...
                                    <c:when test="${!empty loggedUser}">
                                        <c:choose>
                                            <c:when test="${ableToDislike == true}">
                                                <button id="dislike-button" class="dislike-btn"
                                                        onclick="addDislike(${user.id})">
                                                    <i class="glyphicon glyphicon-thumbs-down"> Dislike</i>
                                                </button>
                                            </c:when>
                                            <c:otherwise>
                                                <button disabled id="dislike-button" class="dislike-btn"
                                                        onclick="addDislike(${user.id})">
                                                    <i class="glyphicon glyphicon-thumbs-down"> Dislike</i>
                                                </button>
                                            </c:otherwise>
                                ...
                                <c:choose>
                                    <c:when test="${loggedUser.type == 'A'}">
                                        ...
                                        <input type="button" class="delete" onclick="deleteUser(${user.id})"
                                               value="Удалить юзера"/>
                                    </c:when>
                                </c:choose>
                            </c:otherwise>
                                                ...
                                                <c:choose>
                                                    <c:when test="${loggedUser.id == user.id}">
                                                        ...
                                                        <a class="float-right" href="/editAdvert/${advert.id}">
                                                            <button class="save">Редактировать</button>
                                                        </a>
                                                    </c:when>
                                                    <c:when test="${loggedUser.type == 'A'}">
                                                        <a class="float-right"
                            ...
                            <c:otherwise>
                                <div class="row">
                                    <div class="feedback-form">
                                        ...
                                        <button class="feedback-btn" onclick="addFeedback(${user.id})">Отправить</button>
                                    </div>
                                </div>
